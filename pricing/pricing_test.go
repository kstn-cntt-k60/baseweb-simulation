...
type Pricing struct {
	ProductId     int    `faker:"-" json:"productId"`
	Price         string `faker:"-" json:"price"`
	CurrencyUomId string `faker:"-" json:"currencyUomId"`
	EffectiveFrom string `faker:"timestamp" json:"effectiveFrom"`
}
